<div class="sidebar-container">
  <div class="sidebar-logo">
    <img src="./img/logo-mj-blanc.png" class="img-fluid" alt="">
  </div>
  <ul class="sidebar-navigation">
    ...
    <li class="nav-item"><a class="nav-link js-scroll-trigger" href="./content/discographie.php"><i class="fas fa-compact-disc"></i> Discographie</a></li>
    <li class="nav-item"><a class="nav-link js-scroll-trigger" href="./content/contact.php"><i class="far fa-address-card"></i> Contact</a></li>
  </ul>
</div>